...
const Card = ({ind}) => {
  return (
    <div className="w-[450px] h-[600px] border-nostalgicblue border-4 bg-raddishpinklight rounded-xl shadow-2xl relative overflow-hidden">
      <img
        src={a}
        alt="animal_photo"
      ...
      <div className="w-full h-[55%] border relative z-[10] flex justify-evenly items-start flex-col px-2">
        <div className="flex justify-center gap-2 items-center">
          ...
          <span className="text-2xl font-semibold text-black">Lion</span>
        </div>
        <div className="flex justify-center gap-2 items-center">
        ...
        <div className="flex justify-center gap-2 items-center">
          ...
          <span className="text-xl font-semibold text-wrap">Herbivores</span>
        </div>
        <div className="flex justify-center gap-2 items-center">
          <MdEmail size={25} />
