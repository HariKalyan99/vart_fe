...
const AnimalTable = ({
  ...
  return (
    <>
      <TableRow
        key={induvidual?.id}
        className={`${induvidual?.animalRole === "zookeeper" ? "bg-black" : "bg-saffron"} border-2 hover:border-b-8 hover:border hover:border-white hover:border-l-0 hover:border-r-0 hover:drop-shadow-2xl`}
      >
        <TableCell>
